...
<head>
  ...
  <title>proyek - Portofolio Farid</title>
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="proyek.php" class="active">Proyek</a></li>
  ...
  <main class="main">
    ...
    <section id="portfolio" class="portfolio section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Proyek Saya</h2>
        <p>Proyek sistem informasi berbasis web yang telah saya kembangkan.</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-strategy">
              <div class="portfolio-card">
                <div class="portfolio-img">
                  <img src="assets/img/portfolio/proyek1.png" alt="portfolio Item" class="img-fluid">
                  <div class="portfolio-overlay">
                    <a href="assets/img/portfolio/proyek1.png" class="glightbox portfolio-lightbox"><i class="bi bi-plus"></i></a>
                    <a href="#" class="portfolio-details-link"><i class="bi bi-link"></i></a>
                  </div>
                </div>
                <div class="portfolio-info">
                  <h4>Website Company Profil</h4>
                  <p>Tugas UAS-Membuat Website Perusahaan Kontruksi</p>
